(() => {
  ...
  var n = `<${o}>`;
  var l = document;
  var h = (t2 = "") => l.createComment(t2);
  var r = (t2) => t2 === null || typeof t2 != "object" && typeof t2 != "function";
  var d = Array.isArray;
  var u = (t2) => {
    var i2;
...
`;
  x(myTemplate(), body);
  var myDynamicTemplate = (content) => $`
    <div class="container">
        <p>${content}</p>
    </div>
`;
  x(myDynamicTemplate("This text was passed to the render function"), body);
  x(myTemplate(), body);
  var renderNew = (template, container) => {
    const newElem = document.createElement("div");
    container.appendChild(newElem);
    x(template, newElem);
  };
  renderNew(myDynamicTemplate("try it again"), body);
  x(myDynamicTemplate("overwrite"), body);
  renderNew(myDynamicTemplate("try it again"), body);
  renderNew(myDynamicTemplate("try it again"), body);
  renderNew(myDynamicTemplate("try it again"), body);
